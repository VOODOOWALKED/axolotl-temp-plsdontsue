...
save_fractions: # A list of epoch fractions for checkpointing (e.g., [0.01, 0.1, 0.5, 1.0]). Checkpoints will be named with both the fraction and occurrence count. Mutually exclusive with save_steps and saves_per_epoch.
